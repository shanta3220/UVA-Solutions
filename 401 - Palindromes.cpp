...
bool isMirrored(string input){
    ...
    bool isPalindrome = true;
    for(int i = 0; i<len; i++){
        if(input[i]=='B'||input[i]=='C'||input[i]=='D'||input[i]=='F'||input[i] =='G'||input[i]=='K'||input[i]=='N'||input[i]=='4'||input[i]=='6'||input[i]=='P'||input[i]=='Q' ||input[i]=='R'||input[i]=='7'||input[i]=='9'){
            isPalindrome = false;
            return isPalindrome;
        }
        if(input[i]==input[l-i]){if(input[i]=='Z'||input[i]=='5'||input[i]=='2'||input[i]=='3'||input[i]=='L'||input[i]=='J'||input[i]=='E'||input[i]=='S'){
            isPalindrome = false;
            return isPalindrome;
            }
        }
